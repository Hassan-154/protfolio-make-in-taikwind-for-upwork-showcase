...
<section class="hero-background text-white flex items-center w-full h-screen justify-center" id='hero'>
  ...
  <h1 className='text-4xl pb-4 tracking-wide font-bold sm:text-6xl pb-9 font-play'>Hi, I'm <span className='text-emerald-500'>Hdobi Taylor.</span> A Web Developer.</h1>
